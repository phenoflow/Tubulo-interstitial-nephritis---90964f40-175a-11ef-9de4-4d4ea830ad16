...
(async () => {
  ...
  await fs.writeFile("tubulo-interstitial-nephritis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("tubulo-interstitial-nephritis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
